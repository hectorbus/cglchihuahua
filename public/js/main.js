...
App.controller('main-controller', ['$scope', function($scope) {
  ...
  $scope.conferencistas = [
            ...
            },
            {
                ...
                img: "img/danielleStrickland.png",
                color: "#18b093",
                class: "col-lg-3"
            },
            {
